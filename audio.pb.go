...
type Audio struct {
	...
	// 视频码率
	// @gotags: default:"16k" validate:"required"
	Bitrate string `protobuf:"bytes,3,opt,name=bitrate,proto3" json:"bitrate,omitempty" default:"16k" validate:"required"`
	// 分辨率
	// @gotags: default:"true" validate:"required"
	Variable bool `protobuf:"varint,4,opt,name=variable,proto3" json:"variable,omitempty" default:"true" validate:"required"`
	// 音频采样率
	// @gotags: default:"16000" validate:"required"
	Rate int32 `protobuf:"varint,5,opt,name=rate,proto3" json:"rate,omitempty" default:"16000" validate:"required"`
	// 音频通道
	// @gotags: default:"2" validate:"required"
	Channels int32 `protobuf:"varint,6,opt,name=channels,proto3" json:"channels,omitempty" default:"2" validate:"required"`
	// 音量
	// @gotags: default:"3.0" validate:"required"
	Volume float32 `protobuf:"fixed32,7,opt,name=volume,proto3" json:"volume,omitempty" default:"3.0" validate:"required"`
}
...
func (x *Audio) GetBitrate() string {
	if x != nil {
		return x.Bitrate
	}
	return ""
...
func (x *Audio) GetVolume() float32 {
	if x != nil {
		return x.Volume
	}
	return 0
...
var file_ziyunix_core_audio_proto_rawDesc = []byte{
	...
	,
